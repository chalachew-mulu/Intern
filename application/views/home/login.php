 ...
 <div id="div_username"> 
  <div class="input-group form-group">
    <div class="input-group-prepend mr-3">
      ...
      <label class="bmd-label-floating ml-5">Your Username</label>
...
<div class="footer ml-3" id="name">
  <input class="btn btn-primary ml-5" type="submit" name="login" id="login" value="<?php echo lang('login'); ?>">
   <a href="forgot_password" class="btn btn-primary btn-link btn-wd btn-lg ml-3">forgot username?</a>
</div>
<?php echo form_close(); ?>
</div>
</div>
